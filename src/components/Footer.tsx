...
export default function Footer() {
  ...
  return (
    // ✅ ADDED min-h-[400px] to prevent CLS
    <footer className="relative mt-20 overflow-hidden border-t border-slate-200/80 bg-white/95 backdrop-blur-sm dark:border-white/10 dark:bg-navy-950/95 min-h-[400px]">
